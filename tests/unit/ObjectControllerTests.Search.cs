...
namespace Foundation.ObjectService.WebUI.Tests
{
    public partial class ObjectControllerTests : IClassFixture<ObjectControllerFixture>
    {
        ...
        [InlineData("books102", "pages>=464", 3)]
        [InlineData("books103", "pages<464", 7)]
        [InlineData("books104", "pages>=288", 5)]
        [InlineData("books105", "pages:288", 2)]
        [InlineData("books106", "pages!:288", 8)]
        [InlineData("books107", "title:Slaughterhouse-Five", 1)]
        [InlineData("books108", "title:\"Slaughterhouse-Five\"", 1)]
        [InlineData("books109", "title:\"The Red Badge of Courage\" pages>50", 1)]
        [InlineData("books110", "title:\"The Great Gatsby\" pages>250", 0)]
        [InlineData("books111", "title:\"The Great Gatsby\" pages<250", 1)]
        [InlineData("books112", "title:\"The Great Gatsby\" pages<250 author:\"F. Scott Fitzgerald\"", 1)]
        [InlineData("books113", "author:\"John Steinbeck\"", 2)]
        [InlineData("books114", "author:\"John Steinbeck\" pages<=464", 2)]
        [InlineData("books115", "author:\"John Steinbeck\" pages<464", 1)]
        [InlineData("books116", "pages<464 author:\"John Steinbeck\"", 1)]
        [InlineData("books117", "author:\"Cervantes\"", 0)]
        [InlineData("books118", "author!:\"John Steinbeck\"", 8)]
