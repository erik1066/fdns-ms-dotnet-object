...
namespace Foundation.ObjectService.WebUI.Tests
{
    public class ObjectHealthCheckTests
    {
        ...
        public void Test_Service_Ready()
        {
            ...
            var check = new ObjectDatabaseHealthCheck("unittests-1", mockObjectService.Object, 1000, 2000);
        ...
        public void Test_Service_Degraded()
        {
            ...
            var check = new ObjectDatabaseHealthCheck("unittests-1", mockObjectService.Object, 1, 9000);
            var context = new HealthCheckContext();
